...
CREATE TABLE `area` (
  ...
  `mini_map` varchar(45) DEFAULT NULL,
  `business_id` varchar(35) DEFAULT NULL,
...
INSERT INTO `area` VALUES ('01','Area 1','/images/mapplic/map/mall-basement.png','/images/mapplic/map/mall-basement-small.jpg','01','#4a89dc'),('02','Area 2','/images/mapplic/map/mall-ground.png','/images/mapplic/map/mall-ground-small.jpg','01','#f6bb42'),('03','Area 3','/images/mapplic/map/mall-first.png','/images/mapplic/map/mall-first-small.jpg','01','#3bafda'),('04','Area 4','/images/mapplic/map/mall-basement.png','/images/mapplic/map/mall-basement-small.jpg','01','#70ca63'),('05','Area 5','/images/mapplic/map/mall-ground.png','/images/mapplic/map/mall-ground-small.jpg','02','#967adc');
...
INSERT INTO `business` VALUES ('01','COFFEE','Coffee','Coffee','images/home/services/service-coffee.png','controller/coffee'),('02','RESTAURANT','Restaurant','Restaurant','images/home/services/service-restaurant.png','controller/restaurant'),('03','STORECONVENIENCE','Store','Store Convenience','images/home/services/service-store.png','controller/store');
...
INSERT INTO `category` VALUES ('01','Coffee','01','Traditional Coffee',NULL),('02','Milk and Tea','01','Milk and Tea',NULL),('03','Yogurt','01','Yogurt',NULL),('04','Smoothies','01','Smoothies',NULL),('05','Juices','01','Juices',NULL),('06','Ice cream','01','Ice cream',NULL),('07','Soft Drink','01','Soft Drink',NULL),('41a356936c0449b48165c8b93ab32949','test','01','test description',NULL);
...
INSERT INTO `employee` VALUES ('01','superadmin','17c4520f6cfd1ab53d8745e84681eb49','super','admin','',1,'','','','',NULL,NULL,NULL,'2ecddb45fa33108c1915b0e1cd73319624d8be5b',NULL,NULL,1,NULL,NULL);
...
CREATE TABLE `gallery` (
  ...
  `name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_gallery_product_idx` (`product_id`),
  KEY `fk_gallery_area_idx` (`area_id`),
  KEY `fk_gallery_table` (`table_id`),
  KEY `fk_gallery_sub_category_idx` (`sub_category_id`),
  CONSTRAINT `fk_gallery_area` FOREIGN KEY (`area_id`) REFERENCES `area` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_gallery_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_gallery_sub_category` FOREIGN KEY (`sub_category_id`) REFERENCES `sub_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_gallery_table` FOREIGN KEY (`table_id`) REFERENCES `table_location` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recipe` (
  ...
  KEY `fk_recipe_material_idx` (`material_id`),
  CONSTRAINT `fk_recipe_material` FOREIGN KEY (`material_id`) REFERENCES `material` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `reference_image` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `referenceId_UNIQUE` (`reference_id`),
  UNIQUE KEY `imageId_UNIQUE` (`image_id`),
  UNIQUE KEY `typeFlag_UNIQUE` (`type_flag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sub_category` VALUES ('01','01','Tranditional Coffee'),('02','01','Espresso'),('03','01','Freeze coffee'),('04','01','Non coffee freeze'),('05','02','Tranditional Tea'),('06','03','Basic Yogurt'),('07','04','Basic Smoothies'),('08','04','Fresh fruit smoothies'),('09','05','Basic Juices'),('10','06','Basic Ice Creams'),('11','07','Basic soft drinks'),('12','07','Cigaratte');
...
CREATE TABLE `table_location` (
  ...
  CONSTRAINT `fk_table_area` FOREIGN KEY (`area_id`) REFERENCES `area` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `table_location` VALUES ('01','01','Table 1',4,1,NULL,0.55,0.3,NULL),('02','01','Table 2',4,0,NULL,0.665,0.41,5),('03','01','Table 3',4,0,NULL,0.6012,0.32,8),('04','01','Table 4',4,0,NULL,0.615,0.3416,8),('05','02','Table 5',4,0,NULL,0.59,0.305,8),('06','02','Table 6',4,0,NULL,0.775,0.6833,6),('07','02','Table 7',4,0,NULL,0.5625,0.2166,8),('08','02','Table 8',4,0,NULL,0.1616,0.2706,3),('09','02','Table 9',4,0,NULL,0.425,0.4,NULL),('10','03','Table 10',4,0,NULL,0.4125,0.7416,NULL),('11','03','Table 11',4,0,NULL,0.6187,0.45,NULL),('12','03','Table 12',4,0,NULL,0.275,0.3666,NULL),('13','03','Table 13',4,0,NULL,0.5125,0.7416,NULL),('14','04','Table 14',4,0,NULL,0.4627,0.5202,NULL),('15','04','Table 15',4,0,NULL,0.5625,0.6866,NULL),('16','04','Table 16',4,0,NULL,0.27,0.2333,NULL),('17','04','Table 17',4,0,NULL,0.5573,0.3503,NULL),('18','05','Table 18',4,0,NULL,0.4375,0.425,NULL),('19','05','Table 19',4,0,NULL,0.3625,0.25,NULL),('20','05','Table 20',4,0,NULL,0.6087,0.305,NULL),('21','05','Table 21',4,0,NULL,0.4287,0.2083,NULL);
