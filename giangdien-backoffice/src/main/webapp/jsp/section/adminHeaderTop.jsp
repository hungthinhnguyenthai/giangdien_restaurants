...
<div class="navbar-branding">
    <a class="navbar-brand" href="${pageContext.request.contextPath}/controller/administrator">
        <b>AkTv</b> Admin Dashboard
    </a>
...
<%--    <li class="dropdown menu-merge hidden-xs">
        <a href="#" class="dropdown-toggle select-def" data-toggle="dropdown" role="button" aria-expanded="false">
            Dropdown
        </a>
            ...
            <div class="dropdown-menu dropdown-persist w350 animated animated-shorter fadeIn" role="menu">
                <div class="panel mbn">
                    <div class="panel-menu">
                        ...
                        <button class="btn btn-info btn-xs pull-right" type="button">
                ...
                <div class="panel mbn">
                    <div class="panel-menu">
                        <div class="btn-group btn-group-justified btn-group-nav" role="tablist">
                            <a href="#nav-tab1" data-toggle="tab" class="btn btn-info btn-sm active">Notifications</a>
                            <a href="#nav-tab2" data-toggle="tab" class="btn btn-info btn-sm br-l-n br-r-n">Messages</a>
                            <a href="#nav-tab3" data-toggle="tab" class="btn btn-info btn-sm">Activity</a>
                        </div>
                    </div>
...
<%--                                <div class="media">
                                    <a class="media-left" href="#">
                                        <span class="glyphicon glyphicon-user text-info"></span> </a>
                                ...
                                <div class="media">
                                    <a class="media-left" href="#">
                                        <span class="glyphicon glyphicon-shopping-cart text-success"></span>
                                    </a>
                                ...
                                <div class="media">
                                    <a class="media-left" href="#">
                                        <span class="glyphicon glyphicon-comment text-system"></span> </a>
                                ...
                                <div class="media">
                                    <a class="media-left" href="#">
                                        <span class="glyphicon glyphicon-star text-warning"></span> </a>
                                ...
                                <div class="media">
                                    <a class="media-left" href="#">
                                        <span class="glyphicon glyphicon-usd text-alert"></span> </a>
...
<%--                                <div class="media">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque soltudino.
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-body">
...
<%--                                    <li class="media">
                                        <a class="media-left" href="#">
                                            <img src="assets/img/avatars/5.jpg" class="mw40" alt="avatar"> </a>
                                    ...
                                    <li class="media">
                                        <a class="media-left" href="#">
                                            <img src="assets/img/avatars/2.jpg" class="mw40" alt="avatar"> </a>
                                    ...
                                    <li class="media">
                                        <a class="media-left" href="#">
                                            <img src="assets/img/avatars/3.jpg" class="mw40" alt="avatar"> </a>
                                    ...
                                    <li class="media">
                                        <a class="media-left" href="#">
                                            <img src="assets/img/avatars/4.jpg" class="mw40" alt="avatar"> </a>
    ...
    <li class="dropdown menu-merge">
        <div class="navbar-btn btn-group">
            <button data-toggle="dropdown" class="btn btn-sm dropdown-toggle">
                <span class="flag-xs flag-xs-UK"></span>
                <!-- <span class="h-plus"></span> -->
            </button>
            <ul class="dropdown-menu pv5 animated animated-short flipInX" role="menu">
                <li>
                    <a href="javascript:void(0);">
                        <span class="flag-xs flag-xs-VN mr10"></span> Tieng Viet
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);">
                        <span class="flag-xs flag-xs-KR mr10"></span> Korean
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);">
                        <span class="flag-xs flag-xs-JP mr10"></span> Japanese
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="dropdown menu-merge">
        <a href="#" class="dropdown-toggle avatar p8" data-toggle="dropdown">
            <c:choose>
                <c:when test="${not empty user.profilePicture}">
                    <img src="${pageContext.request.contextPath}/${user.profilePicture}" alt="avatar" class="mw45 br64">
                </c:when>
                <c:otherwise>
                    <img src="${pageContext.request.contextPath}/images/core/profilePlaceHolder.png" alt="avatar" class="mw45 br64">
                </c:otherwise>
            </c:choose>
            <span class="hidden-xs pl15"> ${user.firstName} ${user.lastName}</span>
        ...
        <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
            ...
            <li class="dropdown-footer">
                <a href="${pageContext.request.contextPath}/controller/administrator/logout" class="">
