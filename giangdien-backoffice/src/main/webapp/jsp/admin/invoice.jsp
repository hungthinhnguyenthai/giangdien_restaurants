    ...
    <div class="panel invoice-panel">
        <div class="panel-heading">
            ...
            <div class="panel-header-menu pull-right mr10">
                <button type="button" class="btn btn-xs btn-default  mr5">
                    <i class="fa fa-plus-square pr5"></i> New Invoice</button>
                <a href="javascript:window.print()" class="btn btn-xs btn-default  mr5">
        ...
        <div class="panel-body p20" id="invoice-item">
            ...
            <div class="row mb30">
                ...
                <div class="col-md-4"> <img src="assets/img/logos/logo.png" class="img-responsive center-block mt10 mw200 hidden-xs" alt="Templatemonster.com"> </div>
                <div class="col-md-4">
                    <div class="pull-right text-right">
                        <h2 class="invoice-logo-text hidden lh10">Giang Dien</h2>
                        <h5> Sales Rep:
